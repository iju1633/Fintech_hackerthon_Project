...
import com.example.hackerthonproject.MapsNaverActivity;
import com.example.hackerthonproject.R;
...
public class SplashActivity extends AppCompatActivity {
    ...
    private void checkLocationPermission() { //위치정보권한
    ...
    private void checkLocationSetting() { //위치서비스 활성화 확인
    ...
    private LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            fusedLocationProviderClient.removeLocationUpdates(locationCallback); // 이동된 위치 실시간 반영하려면 이거 삭제

            Intent intent = new Intent(SplashActivity.this, MapsNaverActivity.class);
